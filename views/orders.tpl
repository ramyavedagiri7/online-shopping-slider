			...
			<div class="row">
				...
				<div class="row">
					<div class="control-group">
								...
								<div class="controls">
									<button id="checkoutbtn"  name="CheckOut" class="btn btn-info" method="post" onblur="input_reset(this)">CheckOut</button>
									<button id="reviewbtn"  name="Review your Order" class="btn btn-info" method="post" onblur="input_reset(this)">Review your Order</button>
								</div>
					</div>
				</div>
				...
				<div id="MyTotalCost" class="row">
					...
					<h3 style="color: #0077b3; font-weight: bold;">This text will change<h3>
				</div>
				</div>
			</div>
